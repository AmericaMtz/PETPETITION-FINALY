 ...
 * @author Alumno
 */
@WebServlet(name = "MBuscaServlet", urlPatterns = {"/MBuscaServlet"})
public class MBuscaServlet extends HttpServlet {
...
"    INNER JOIN personas ON personas.NickName = MascotasPerdidas.dueño;");
        ...
        getServletContext().getRequestDispatcher("/JSP/MBusca.jsp").forward(request, response);
    }
